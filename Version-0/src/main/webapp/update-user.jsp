...
<%!String username, password, permission, uid;%>


<%
String id = request.getParameter("id");
uid = id;
String sql = "SELECT * FROM `user_auth` WHERE uid='" + id + "'";
...
while (rs.next()) {
	...
	permission = rs.getString("permission_tokken");
}
%>
...
<title>Update - <%=(String) session.getAttribute("username")%></title>
</head>
<body>
	...
	<div class="container my-3">
		<h1 class="text-center alert-info py-2">Change user details</h1>
		<form action="update-now" method="post">
			<div class="mb-3">
				<label for="exampleusername" class="form-label">Username</label> <input
					type="text" name="username" class="form-control"
					id="exampleusername" aria-describedby="username"
			...
			<div class="mb-3">
				<select class="form-select" name="permission_token" aria-label="Default select example">
					<option selected value="0">Member (Normal user)</option>
