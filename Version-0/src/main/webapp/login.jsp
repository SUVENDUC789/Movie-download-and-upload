		...
		<div class="row">
			...
			<div class="col-sm-4" style="border: 2px solid gray; padding: 50px;">
				...
				<div class="page-header">
					<h2 class="specialHead">Sign in Here</h2>
				</div>
				...
				<div class="msg">
					...
					if (request.getMethod().equalsIgnoreCase("post")) {
						...
						String sql = "SELECT * FROM `user_auth` WHERE username = '" + username + "'";
						...
						if (newuser == 0) {
							String newusercreatequery = "INSERT INTO `user_auth` (`uid`, `username`, `password`, `permission_tokken`, `datetime_now`) VALUES (NULL, '"
							+ username + "', '" + password + "', '0', current_timestamp())";
							int c = dao.runMysqlQuery(newusercreatequery);
							if (c != 0) {
						out.println("<div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">\r\n"
								+ "  <strong>" + username + "</strong>Sign in successfull please wait.\r\n"
							...
							String alreadypresentuser = "SELECT * FROM `user_auth` WHERE username='" + username + "' AND password='"
							+ password + "'";

							ResultSet rs2 = dao.fetchData(alreadypresentuser);
							int isok = 0;
							while (rs2.next()) {
						isok++;
							}
						...
						out.println("<div class=\"alert alert-danger alert-dismissible fade show\" role=\"alert\">\r\n"
								+ "  <strong>" + username + "</strong> please provide correct password.\r\n"
								+ "  <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button>\r\n"
								+ "</div>");
							}
				...
				<form action="login.jsp" method="POST">
					<div class="form-group">
						<label for="">Username</label><br> <input type="text"
							...
							class="form-control" required><br> <label for="">Password</label><br>
						<input type="password" name="password" id="password"
							class="form-control" placeholder="Enter Password" required><br>

						<button type="submit"
							class="btn btn-block span btn-primary nowHide">
								...
								.keyup(
										function() {
											...
											if (uname.search(" ") != -1
												...
												$(".msg")
														.text(
																"Username does't contain use blank_space and single_coute and also hyphen symbol")
														.css("color", "red");
												$(".nowHide").hide();
											}
								...
								.keyup(
										function() {
											...
											if (password.search(" ") != -1
												...
												$(".msg")
														.text(
																"Password does't contain use blank_space and single_coute and also hyphen symbol")
														.css("color", "red");
												$(".nowHide").hide();
											}
